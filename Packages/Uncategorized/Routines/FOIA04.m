FOIA04 ;SLC-ISC/RJS - SCRUB MAG KIDS FILES ; 09/09/2011
 ;
 K ^TMP($J)
 ;
 S HOME=$I
 ...
 ..; MAGDRUID CODE
 ..; 
 ..I (RTEXT["""RTN"",""MAGDRUID"","),(VTEXT["Veterans' Administration") D
 ...D REPL(.VTEXT,"Veterans' Administration","<Your Agency Name goes Here>")
 ...S ^TMP($J,"FDATA",LINE+1)=VTEXT
 ..;
 ..I (RTEXT["""RTN"",""MAGDRUID"","),(VTEXT["1.2.840.113754") D
 ...D REPL(.VTEXT,"1.2.840.113754","<Your Agency UID Root goes Here>")
 ...S ^TMP($J,"FDATA",LINE+1)=VTEXT
 ..;
 ..I '(RTEXT[",0)") S XREF($P(RTEXT,"""",4))=LINE+1
 ..S REF="^TMP($J,"_RTEXT,@REF=VTEXT
 .;
