ExtJS2Code ; ExtJS tag processor fixed code
 ;
 ; ----------------------------------------------------------------------------
...
gridCheckbox ;
 ...
 ;;
zextUpdateSession
 ;;<ewd:config pageType="ajax" isFirstPage="false" prepagescript="updateSession^ExtJS">
 ;;<span>&nbsp;</span>
 ;;***END***
 ;;
EWDext
...
updateSession ;
 ...
 ;;  ewd:updateSession^ExtJS(sessionName,row,column,value) ;
 ;;};
 ;;***END***
 ;;
desktop ;
...
zextDesktopWindowLoader
 ;;<ewd:config isFirstPage="false" pageType="ajax" prePageScript="desktopWindowLoader^ExtJS2">
