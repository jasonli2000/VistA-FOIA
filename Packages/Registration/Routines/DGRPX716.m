...
4 S DW=".36;1",DV="*P8'Xa",DU="",DLB="PRIMARY ELIGIBILITY CODE",DIFLD=.361
 S DE(DW)="C4^DGRPX716",DE(DW,"INDEX")=1
 S DU="DIC(8,"
 G RE
...
X6 S DFN=DA D AAC^DGLOCK2
 ...
 ;
7 S D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPX717",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW="ELIGIBILITY",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DIC(8,"
...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,D=0 K DE(1) ;.3731
 S DIFLD=.3731,DGO="^DGRPX718",DC="2^2.05A^.373^",DV="2.05MFX",DW="0;1",DOW="SERVICE CONNECTED CONDITIONS",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
