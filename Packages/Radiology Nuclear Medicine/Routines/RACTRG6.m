...
X24 S RAFM(1)=+^RAMIS(71,RAPRI,"F",RAI,0),RAFM1=+$P(^(0),U,2),RAFM=$S($D(^RA(78.4,RAFM(1),0)):$P(^(0),U),1:-1),RAFM=$S('$D(^("I")):RAFM,'^("I"):RAFM,1:-1) S:RAFM<0 Y="@200"
 Q
25 S D=0 K DE(1) ;50
 S DIFLD=50,DGO="^RACTRG7",DC="2^70.04PA^F^",DV="70.04M*P78.4'",DW="0;1",DOW="FILM SIZE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="RA(78.4,"
...
X29 S:'$P(RAMDV,U,10) Y="@350"
 Q
30 S D=0 K DE(1) ;75
 S DIFLD=75,DGO="^RACTRG8",DC="3^70.05DA^T^",DV="70.05DX",DW="0;1",DOW="STATUS CHANGE DATE/TIME",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
