 ;GT.M version of page xrefPageToScript (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="xrefPageToScript"
 ...
 s Error=$$startSession^%zewdPHP("xrefPageToScript",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <h5>"_$c(13,10)
 .w "Scripts referenced by each page in the "_$$getSessionValue^%zewdAPI("app",sessid)_" application"_""
 .w "   </h5>"_$c(13,10)
 .if ($$existsInSession^%zewdAPI("scriptCalls",sessid)) d
 ...
 ..f  q:'(($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom))'=endValue43)&($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom))'=nul))  d
 ...s pageFrom=$o(^%zewdSession("session",sessid,"scriptCalls",pageFrom))
 ...s data=$g(^%zewdSession("session",sessid,"scriptCalls",pageFrom))
 ...w "            <tr>"_$c(13,10)
 ...w "               <td align=""center"" class=""listingCol"">"_$c(13,10)
 ...w pageFrom
 ...w "               </td>"_$c(13,10)
 ...
 ...s scriptCalled=""
 ...i scriptCalled?1N.N s scriptCalled=scriptCalled-1
 ...i scriptCalled?1AP.ANP d
 .... s p1=$e(scriptCalled,1,$l(scriptCalled)-1)
 .... s p2=$e(scriptCalled,$l(scriptCalled))
 .... s p2=$c($a(p2)-1)
 .... s scriptCalled=p1_p2
 ...s nul=""
 ...s endValue60=""
 ...i endValue60?1N.N s endValue60=endValue60+1
 ...f  q:'(($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))'=endValue60)&($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))'=nul))  d
 ....s scriptCalled=$o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))
 ....s type=$g(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))
 ....w scriptCalled
 ....w "                     <br />"_$c(13,10)
 ....
 ...w "               </td>"_$c(13,10)
 ...
 ...f  q:'(($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))'=endValue76)&($o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))'=nul))  d
 ....s scriptCalled=$o(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))
 ....s type=$g(^%zewdSession("session",sessid,"scriptCalls",pageFrom,scriptCalled))
 ....w type
 ....w "                     <br />"_$c(13,10)
