 ;GT.M version of page gtmHome (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="gtmInitialise^%zewdMgr2"
 ...
 s sessionArray("ewd_pageName")="gtmHome"
 s sessionArray("ewd_translationMode")="0"
 s sessionArray("ewd_technology")="gtm"
 s sessionArray("ewd_pageType")=""
 s tokens("gtmHome")=$$setNextPageToken^%zewdGTMRuntime("gtmHome")
 s tokens("vaInitialPage")=$$setNextPageToken^%zewdGTMRuntime("vaInitialPage")
 ...
 s Error=$$startSession^%zewdPHP("gtmHome",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w "        EWD.ajax.makeRequest('/vista/ewdMgr/vaInitialPage.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("vaInitialPage")_"&ewd_urlNo=gtmHome1',""bodyContent"",'get','','') ;"_$c(13,10)
 w "      } ;"_$c(13,10)
 ...
 w ""_""
 w "      </script>"_$c(13,10)
 w "      <meta content='3500;URL=/vista/ewdMgr/gtmHome.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("gtmHome")_"&ewd_urlNo=gtmHome1' http-equiv=""Refresh"" />"_$c(13,10)
 w "   </head>"_$c(13,10)
 ...
 w "&copy; 2004-2009 M/Gateway Developments Ltd All Rights Reserved. &nbsp;&nbsp;&nbsp;&nbsp;"_""
