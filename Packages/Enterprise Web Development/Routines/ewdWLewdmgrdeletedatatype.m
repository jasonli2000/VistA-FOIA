 ;GT.M version of page deleteDataType (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="delDataType^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="deleteDataType"
 ...
 s Error=$$startSession^%zewdPHP("deleteDataType",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/dataTypes.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("dataTypes")_"&ewd_urlNo=deleteDataType1',""mainmenu"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
