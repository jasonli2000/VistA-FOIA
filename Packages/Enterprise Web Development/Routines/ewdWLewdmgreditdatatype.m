 ;GT.M version of page editDataType (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getDataTypeDetails^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="editDataType"
 ...
 s formInfo="cancel|button`dataTypeNotes|textarea`dtSubmit|submit`ewd_pressed|hidden`inputMethod|text`outputMethod|text`"
 d setMethodAndNextPage^%zewdCompiler20("dtSubmit","saveDataType^%zewdMgrAjax","configSettingsSaved",formInfo,.sessionArray)
 s Error=$$startSession^%zewdPHP("editDataType",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Data Type: "_$$getSessionValue^%zewdAPI("tagName",sessid)
 .w "      </h5>"_$c(13,10)
 .w "      <div class=""applicationPanel"" style=""height:320px; width:97%"">"_$c(13,10)
 .w "         <form action='/vista/ewdMgr/editDataType.mgwsi?ewd_token="_$$getSessionValue^%zewdAPI("ewd_token",sessid)_"' method=""post"" name=""ewdForm1"">"_$c(13,10)
 ...
 .w "                     <input class=""actionButton"" id=""dtSubmit"" name=""dtSubmit"" onClick=""this.form.ewd_action.value=this.name ; this.form.ewd_pressed.value=this.name ; EWD.ajax.submit(this.name,this.form,'configSettingsSaved','/vista/ewdMgr/editDataType.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("editDataType")_"&ewd_urlNo=editDataType1','nullId','') ;"" type=""button"" value=""Save"" />"_$c(13,10)
