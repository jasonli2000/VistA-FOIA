 ;GT.M version of page docPurpose (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="docPurpose"
 ...
 s Error=$$startSession^%zewdPHP("docPurpose",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <span>"_$c(13,10)
 .w "      <textarea cols=""70"" id=""missingName10"" name=""missingName10"" rows=""10"">"_$c(13,10)
 .w $$getSessionValue^%zewdAPI("domPurpose",sessid)
