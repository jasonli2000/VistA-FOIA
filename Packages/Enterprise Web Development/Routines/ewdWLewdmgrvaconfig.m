 ;GT.M version of page vaConfig (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="vaConfig"
 ...
 s tokens("vaConfigMenu")=$$setNextPageToken^%zewdGTMRuntime("vaConfigMenu")
 s Error=$$startSession^%zewdPHP("vaConfig",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <div>"_$c(13,10)
 .w "      <div style=""font-size:18pt;font-family:arial;text-align:center"">"_$c(13,10)
 .w "EWD Virtual Appliance: Configuration Notes"_""
 .w "      </div>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <div id=""configMenuHere"">"_$c(13,10)
 .w "</div>"_$c(13,10)
 .w "   </div>"_$c(13,10)
 .
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/vaConfigMenu.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("vaConfigMenu")_"&ewd_urlNo=vaConfig1',""configMenuHere"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
