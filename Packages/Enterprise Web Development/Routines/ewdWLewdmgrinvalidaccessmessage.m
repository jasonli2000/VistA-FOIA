 ;GT.M version of page invalidAccessMessage (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="invalidAccessMessage"
 ...
 s Error=$$startSession^%zewdPHP("invalidAccessMessage",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <h4>"_$c(13,10)
 .w "You do not have access to this application"_""
 .w "   </h4>"_$c(13,10)
 .
