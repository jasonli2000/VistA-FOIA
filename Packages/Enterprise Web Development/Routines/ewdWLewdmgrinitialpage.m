 ;GT.M version of page initialPage (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="redirect^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="initialPage"
 ...
 s Error=$$startSession^%zewdPHP("initialPage",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
