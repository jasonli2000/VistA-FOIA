 ;GT.M version of page compilePageResults (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="compilePage^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="compilePageResults"
 ...
 s Error=$$startSession^%zewdPHP("compilePageResults",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "      <tr>"_$c(13,10)
 .w "         <td align=""left"" class=""listingCol"" width=""35%"">"_$c(13,10)
 .w $$getSessionValue^%zewdAPI("fileName",sessid)
 .w "         </td>"_$c(13,10)
 .w "         <td align=""right"" class=""listingCol"" width=""12%"">"_$c(13,10)
 .w $$getSessionValue^%zewdAPI("fileSize",sessid)
 .w "         </td>"_$c(13,10)
 .w "         <td align=""center"" class=""listingCol"" width=""25%"">"_$c(13,10)
 .w $$getSessionValue^%zewdAPI("fileModified",sessid)
 .w "         </td>"_$c(13,10)
 .w "         <td class=""listingCol"">"_$c(13,10)
 .w "            <input class=""actionButton"" id=""recomp"" name=""recomp"" onclick=""MGW.page.compilePage('"_$$getSessionValue^%zewdAPI("fileName",sessid)_"')"" type=""button"" value=""Compile"" />"_$c(13,10)
 .w "            <input class=""actionButton"" id=""list"" name=""list"" onclick=""MGW.page.listPage('"_$$getSessionValue^%zewdAPI("fileName",sessid)_"')"" type=""button"" value=""List"" />"_$c(13,10)
 .w "         </td>"_$c(13,10)
 .w "      </tr>"_$c(13,10)
 .w "   </table>"_$c(13,10)
 .
