 ;GT.M version of page deleteCustomTag (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="delCustomTag^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="deleteCustomTag"
 ...
 s Error=$$startSession^%zewdPHP("deleteCustomTag",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/customTags.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("customTags")_"&ewd_urlNo=deleteCustomTag1',""mainmenu"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
