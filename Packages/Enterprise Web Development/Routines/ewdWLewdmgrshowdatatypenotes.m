 ;GT.M version of page showDataTypeNotes (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getDataTypeNotes^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="showDataTypeNotes"
 ...
 s Error=$$startSession^%zewdPHP("showDataTypeNotes",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Documentation for "_$$getSessionValue^%zewdAPI("dataTypeName",sessid)
 .w "      </h5>"_$c(13,10)
 .w "      <div class=""applicationPanel"" style=""height:370px; width:97%"">"_$c(13,10)
 .w "         <form action='/vista/ewdMgr/showDataTypeNotes.mgwsi?ewd_token="_$$getSessionValue^%zewdAPI("ewd_token",sessid)_"' method=""post"" name=""ewdForm1"">"_$c(13,10)
 .w "            <table border=""0"" class=""propsTable"" style=""table-layout:fixed"" width=""100%"">"_$c(13,10)
 .w "               <tr>"_$c(13,10)
 .w "                  <td class=""configRow"">"_$c(13,10)
 .w "                     <textarea cols=""55"" id=""dataTypeNotes"" name=""dataTypeNotes"" rows=""15"">"_$c(13,10)
