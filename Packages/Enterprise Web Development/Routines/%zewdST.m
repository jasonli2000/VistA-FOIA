%zewdST ; Sencha Touch Tag Processors and runtime logic ; 1/24/12 4:35pm
 ;
...
list(nodeOID,itemsOID)
 ...
 . i $g(mainAttrs("synch"))'="" d  ;DLW
 . . s text=text_"var synch=" ;DLW
 . . s text=text_mainAttrs("synch")_";" ;DLW
 . . s text=text_"EWD.ajax.getPage({page:page,synch:synch,nvp:nvp});" ;DLW
 . . k mainAttrs("synch") ;DLW
 . e  d  ;DLW
 . . s text=text_"EWD.ajax.getPage({page:page,nvp:nvp});" ;DLW
