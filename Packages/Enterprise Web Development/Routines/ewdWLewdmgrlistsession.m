 ;GT.M version of page listSession (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getSessionDetails^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="listSession"
 ...
 s Error=$$startSession^%zewdPHP("listSession",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Session "_$$getSessionValue^%zewdAPI("sessionNo",sessid)
 .w "   </h5>"_$c(13,10)
 .w "   <div class=""applicationPanel"" style=""height:370px; overflow:scroll; width:97%"">"_$c(13,10)
 ...
 .w "            </td>"_$c(13,10)
 .w "         </tr>"_$c(13,10)
 .d displaySessionDetails^%zewdMgrAjax($$getSessionValue^%zewdAPI("ewd_sessid",sessid))
 .w "      </table>"_$c(13,10)
 .w "   </div>"_$c(13,10)
 .
