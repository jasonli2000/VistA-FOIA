 ;GT.M version of page ewdAjaxErrorRedirect (VistACom application)
...
body ;
 if ($g(Error)="") d
 .w "   <span>"_$c(13,10)
 .w "      <div href='/vista/VistACom/ewdErrorRedirect.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("ewdErrorRedirect")_"&ewd_urlNo=ewdAjaxErrorRedirect1' id=""zewdRef"">"_$c(13,10)
 .w "</div>"_$c(13,10)
 .w "   </span>"_$c(13,10)
 .
