 ;GT.M version of page logout (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="logout"
 ...
 s Error=$$startSession^%zewdPHP("logout",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w ""_$c(13,10)
 w "  document.location = '/vista/ewdMgr/gtmHome.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("gtmHome")_"' ;"_$c(13,10)
 w ""_""
 w "   </pre>"_$c(13,10)
 w "</span>"_$c(13,10)
 QUIT
