 ;GT.M version of page xrefPageToTag (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="xrefPageToTag"
 ...
 s Error=$$startSession^%zewdPHP("xrefPageToTag",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <h5>"_$c(13,10)
 .w "Custom Tags referenced by each page in the "_$$getSessionValue^%zewdAPI("app",sessid)_" application"_""
 .w "   </h5>"_$c(13,10)
 .if ($$existsInSession^%zewdAPI("tagCalls",sessid)) d
 ...
 ..f  q:'(($o(^%zewdSession("session",sessid,"tagCalls",pageFrom))'=endValue36)&($o(^%zewdSession("session",sessid,"tagCalls",pageFrom))'=nul))  d
 ...s pageFrom=$o(^%zewdSession("session",sessid,"tagCalls",pageFrom))
 ...s data=$g(^%zewdSession("session",sessid,"tagCalls",pageFrom))
 ...w "            <tr>"_$c(13,10)
 ...w "               <td align=""center"" class=""listingCol"">"_$c(13,10)
 ...w pageFrom
 ...w "               </td>"_$c(13,10)
 ...
 ...s tagCalled=""
 ...i tagCalled?1N.N s tagCalled=tagCalled-1
 ...i tagCalled?1AP.ANP d
 .... s p1=$e(tagCalled,1,$l(tagCalled)-1)
 .... s p2=$e(tagCalled,$l(tagCalled))
 .... s p2=$c($a(p2)-1)
 .... s tagCalled=p1_p2
 ...s nul=""
 ...s endValue53=""
 ...i endValue53?1N.N s endValue53=endValue53+1
 ...f  q:'(($o(^%zewdSession("session",sessid,"tagCalls",pageFrom,tagCalled))'=endValue53)&($o(^%zewdSession("session",sessid,"tagCalls",pageFrom,tagCalled))'=nul))  d
 ....s tagCalled=$o(^%zewdSession("session",sessid,"tagCalls",pageFrom,tagCalled))
 ....s type=$g(^%zewdSession("session",sessid,"tagCalls",pageFrom,tagCalled))
 ....w tagCalled
 ....w "                     <br />"_$c(13,10)
 ....
 ...w "               </td>"_$c(13,10)
