 ;GT.M version of page docTypCall (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="docTypCall"
 ...
 s Error=$$startSession^%zewdPHP("docTypCall",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w $$getSessionValue^%zewdAPI("domCall",sessid)
