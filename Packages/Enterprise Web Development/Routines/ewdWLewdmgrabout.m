 ;GT.M version of page about (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="about^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="about"
 ...
 s Error=$$startSession^%zewdPHP("about",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "      <br />"_$c(13,10)
 .w "      <center>"_$c(13,10)
 .w "This is version 3.0 of the ewdMgr application (26 January 2009)"_""
 .w "         <br />"_$c(13,10)
 .w "         <br />"_$c(13,10)
 .w "You are running the Free Open Source version of "_$$getSessionValue^%zewdAPI("ewdVersion",sessid)_": "_$$getSessionValue^%zewdAPI("ewd_date",sessid)
 .w "         <p>"_$c(13,10)
 .w "&copy; 2004-2011, M/Gateway Developments Ltd. (All Rights Reserved)"_""
 .w "         </p>"_$c(13,10)
 .w "For support, see &nbsp;"_""
 .w "         <a href=""http://www.mgateway.com"">"_$c(13,10)
 .w "http://www.mgateway.com"_""
 .w "         </a>"_$c(13,10)
 .w "         <br />"_$c(13,10)
 .w "         <br />"_$c(13,10)
 .w "         <div style=""width:50%;text-align:left"">"_$c(13,10)
 .w "            <p>"_$c(13,10)
 .w "This program is free software: you can redistribute it and/or modify it under the terms of the GNU  Affero General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version."_""
 .w "            </p>"_$c(13,10)
 .w "            <p>"_$c(13,10)
 .w "This program is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU Affero General Public License for more details."_""
 .w "            </p>"_$c(13,10)
 .w "            <p>"_$c(13,10)
 .w "You should have received a copy of the GNU Affero General Public License along with this program.  If not, see &lt;http://www.gnu.org/licenses/&gt;."_""
 .w "            </p>"_$c(13,10)
 .w "         </div>"_$c(13,10)
 .w "      </center>"_$c(13,10)
 .w "   </div>"_$c(13,10)
