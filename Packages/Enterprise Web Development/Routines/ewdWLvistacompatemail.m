 ;GT.M version of page patemail (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="PATEMAIL^C0ECCR"
 ...
 s sessionArray("ewd_pageName")="patemail"
 ...
 s Error=$$startSession^%zewdPHP("patemail",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w "Ext.getCmp(EWD.sencha.modalPanel).hide();  Ext.Msg.alert('Attention', 'Your mail with CCR has been sent', Ext.emptyFn);"_""
 w "</pre>"_$c(13,10)
