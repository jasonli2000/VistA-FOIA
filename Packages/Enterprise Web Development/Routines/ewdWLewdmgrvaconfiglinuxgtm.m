 ;GT.M version of page vaConfigLinuxGTM (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="vaConfigLinuxGTM"
 ...
 s Error=$$startSession^%zewdPHP("vaConfigLinuxGTM",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "   <span>"_$c(13,10)
 .w "      <h3>"_$c(13,10)
 .w "How Ubuntu Linux and GT.M have been configured to support EWD"_""
 .w "      </h3>"_$c(13,10)
 .w "EWD requires globals that can handle record lengths up to 32k. In order to support this, the kernel shared memory first had to be increased.   This has been defined in"_""
 .w "      <i>"_$c(13,10)
 .w "/etc/sysctl.conf"_""
 .w "      </i>"_$c(13,10)
 .w "where you'll find the line:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "kernel.shmmax = 134217728"_""
 .w "      </i>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "You can check that this value has been accepted using:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "sysctl -a |grep shmmax"_""
 .w "      </i>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "Secondly, the globals that are used within the"_""
 .w "      <i>"_$c(13,10)
 .w "/usr/local/gtm/ewd"_""
 .w "      </i>"_$c(13,10)
 .w "directory were defined using the GT.M Global Definition Editor (^GDE)  as follows:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "GTM&gt;d ^GDE"_""
 .w "         <br />"_$c(13,10)
 .w "change -segment default -block=32256"_""
 .w "         <br />"_$c(13,10)
 .w "change -region default key=255 -record=32240"_""
 .w "         <br />"_$c(13,10)
 .w "exit"_""
 .w "         <br />"_$c(13,10)
 .w "mupip create"_""
