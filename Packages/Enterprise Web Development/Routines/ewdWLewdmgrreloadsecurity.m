 ;GT.M version of page reloadSecurity (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="reloadSecurity"
 ...
 s Error=$$startSession^%zewdPHP("reloadSecurity",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/security.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("security")_"&ewd_urlNo=reloadSecurity1',""mainmenu"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
