 ;GT.M version of page reloadDataTypes (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="reloadDataTypes"
 ...
 s Error=$$startSession^%zewdPHP("reloadDataTypes",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/dataTypes.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("dataTypes")_"&ewd_urlNo=reloadDataTypes1',""mainmenu"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
