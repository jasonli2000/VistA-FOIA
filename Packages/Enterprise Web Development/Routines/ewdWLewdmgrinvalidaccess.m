 ;GT.M version of page invalidAccess (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="invalidAccess"
 ...
 s tokens("invalidAccessMessage")=$$setNextPageToken^%zewdGTMRuntime("invalidAccessMessage")
 s Error=$$startSession^%zewdPHP("invalidAccess",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "            <tr>"_$c(13,10)
 .w "               <td>"_$c(13,10)
 .w "                  <table class=""innerTabs"" id=""invalidAccessMenu"" style=""top: -55px;"">"_$c(13,10)
 .w "                     <tr>"_$c(13,10)
 .w "                        <td id=""invalidAccessMessageTab"" onClick=""EWD.page.fetchinvalidAccessMessage(); EWD.page.setInnerTabPage(this)"" onMouseOut=""EWD.page.deSelectInnerTab(this)"" onMouseOver=""EWD.page.selectInnerTab(this)"">"_$c(13,10)
 .w "Error"_""
 .w "                        </td>"_$c(13,10)
 .w "                     </tr>"_$c(13,10)
 .w "                  </table>"_$c(13,10)
 .w "                  <div class=""innerPanel"" id=""invalidAccess"" style=""top: -58px;width:100%"">"_$c(13,10)
 .w "&nbsp;"_""
 .w "                  </div>"_$c(13,10)
 .w "               </td>"_$c(13,10)
 .w "            </tr>"_$c(13,10)
 ...
 w ""_""
 w "EWD.page.defineInnerTab('invalidAccess','invalidAccessMessageTab',true) ;"_$c(13,10)
 w "EWD.page.fetchinvalidAccessMessage = function () {"_$c(13,10)
 w "  EWD.ajax.makeRequest('/vista/ewdMgr/invalidAccessMessage.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("invalidAccessMessage")_"&ewd_urlNo=invalidAccess1','invalidAccess','get','','') ;"_$c(13,10)
 w "} ;"_$c(13,10)
 w "EWD.page.fetchinvalidAccessMessage() ;"_$c(13,10)
 w ""_""
 w "   </pre>"_$c(13,10)
 w "</span>"_$c(13,10)
 QUIT
