 ;GT.M version of page reloadCustomTags (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="reloadCustomTags"
 ...
 s Error=$$startSession^%zewdPHP("reloadCustomTags",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/customTags.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("customTags")_"&ewd_urlNo=reloadCustomTags1',""mainmenu"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
