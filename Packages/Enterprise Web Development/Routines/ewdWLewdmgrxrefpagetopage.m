 ;GT.M version of page xrefPageToPage (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="xrefPageToPage"
 ...
 s Error=$$startSession^%zewdPHP("xrefPageToPage",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "   <span>"_$c(13,10)
 .w "      <h5>"_$c(13,10)
 .w "Pages that are referenced by each page in the "_$$getSessionValue^%zewdAPI("app",sessid)_" application"_""
 .w "      </h5>"_$c(13,10)
 .if ($$existsInSession^%zewdAPI("pageCalls",sessid)) d
 ...
 ..s nul=""
 ..s endValue63=""
 ..i endValue63?1N.N s endValue63=endValue63+1
 ..f  q:'(($o(^%zewdSession("session",sessid,"pageCalls",pageFrom))'=endValue63)&($o(^%zewdSession("session",sessid,"pageCalls",pageFrom))'=nul))  d
 ...s pageFrom=$o(^%zewdSession("session",sessid,"pageCalls",pageFrom))
 ...s data=$g(^%zewdSession("session",sessid,"pageCalls",pageFrom))
 ...w "               <tr>"_$c(13,10)
 ...w "                  <td align=""center"" class=""listingCol"">"_$c(13,10)
 ...w pageFrom
 ...w "                  </td>"_$c(13,10)
 ...
 ...s nul=""
 ...s endValue80=""
 ...i endValue80?1N.N s endValue80=endValue80+1
 ...f  q:'(($o(^%zewdSession("session",sessid,"pageCalls",pageFrom,pageCalled))'=endValue80)&($o(^%zewdSession("session",sessid,"pageCalls",pageFrom,pageCalled))'=nul))  d
 ....s pageCalled=$o(^%zewdSession("session",sessid,"pageCalls",pageFrom,pageCalled))
 ....s data2=$g(^%zewdSession("session",sessid,"pageCalls",pageFrom,pageCalled))
 ....w pageCalled
 ....w "                        <br />"_$c(13,10)
 ....
 ...w "                  </td>"_$c(13,10)
