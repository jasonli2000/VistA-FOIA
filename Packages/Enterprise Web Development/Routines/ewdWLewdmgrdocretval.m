 ;GT.M version of page docRetVal (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="docRetVal"
 ...
 s Error=$$startSession^%zewdPHP("docRetVal",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <span>"_$c(13,10)
 .w "      <textarea cols=""40"" id=""missingName10"" name=""missingName10"" rows=""10"">"_$c(13,10)
 .w $$getSessionValue^%zewdAPI("domReturn",sessid)
