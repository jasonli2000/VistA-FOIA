 ;GT.M version of page configSettingsSaved (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="configSettingsSaved"
 ...
 s Error=$$startSession^%zewdPHP("configSettingsSaved",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w ""_$c(13,10)
 w "  var buttonId = '"_$$getSessionValue^%zewdAPI("ewd.pressed",sessid)_"' ;"_$c(13,10)
 w "  var obj = document.getElementById(buttonId) ;"_$c(13,10)
 w "  var xcoord = EWD.utils.findPosX(obj) ;  var ycoord = EWD.utils.findPosY(obj) ;    var point = document.getElementById(""alertPanel"") ;"_$c(13,10)
 w "  point.className = ""alertPanelOn"" ;"_$c(13,10)
 w "  point.style.left = xcoord - 30 ;"_$c(13,10)
 w "  point.style.top = ycoord - 200 ;"_$c(13,10)
 w "  setTimeout(""document.getElementById('alertPanel').className = 'alertPanelOff'"",1000) ;"_$c(13,10)
 w ""_""
 w "   </pre>"_$c(13,10)
 w "</span>"_$c(13,10)
 QUIT
