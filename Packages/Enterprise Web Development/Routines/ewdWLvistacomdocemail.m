 ;GT.M version of page docemail (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="DOCEMAIL^C0ECCR"
 ...
 s sessionArray("ewd_pageName")="docemail"
 ...
 s Error=$$startSession^%zewdPHP("docemail",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
