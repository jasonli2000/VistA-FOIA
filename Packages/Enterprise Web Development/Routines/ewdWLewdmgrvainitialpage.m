 ;GT.M version of page vaInitialPage (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="vaRedirect^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="vaInitialPage"
 ...
 s Error=$$startSession^%zewdPHP("vaInitialPage",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
