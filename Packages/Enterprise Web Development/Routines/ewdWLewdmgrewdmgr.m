 ;GT.M version of page ewdMgr (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="ewdMgr"
 ...
 s tokens("mainMenu")=$$setNextPageToken^%zewdGTMRuntime("mainMenu")
 s Error=$$startSession^%zewdPHP("ewdMgr",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Enterprise Web Developer Management Portal"_""
 .w "      </div>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <div id=""mainMenuHere"">"_$c(13,10)
 .w "</div>"_$c(13,10)
 .w "   </div>"_$c(13,10)
 .
 ...
 w " } else {EWD.ajax.makeRequest('/vista/ewdMgr/mainMenu.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("mainMenu")_"&ewd_urlNo=ewdMgr1',""mainMenuHere"",'get','','') ; }"_""
 w "</span>"_$c(13,10)
 QUIT
