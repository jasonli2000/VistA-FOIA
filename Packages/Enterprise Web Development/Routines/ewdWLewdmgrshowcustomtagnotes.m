 ;GT.M version of page showCustomTagNotes (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getCustomTagNotes^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="showCustomTagNotes"
 ...
 s Error=$$startSession^%zewdPHP("showCustomTagNotes",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Documentation for &lt;"_$$getSessionValue^%zewdAPI("tagName",sessid)_"&gt;"_""
 .w "      </h5>"_$c(13,10)
 .w "      <div class=""applicationPanel"" style=""height:370px; width:97%"">"_$c(13,10)
 .w "         <form action='/vista/ewdMgr/showCustomTagNotes.mgwsi?ewd_token="_$$getSessionValue^%zewdAPI("ewd_token",sessid)_"' method=""post"" name=""ewdForm1"">"_$c(13,10)
 .w "            <table border=""0"" class=""propsTable"" style=""table-layout:fixed"" width=""100%"">"_$c(13,10)
 .w "               <tr>"_$c(13,10)
 .w "                  <td class=""configRow"">"_$c(13,10)
 .w "                     <textarea cols=""55"" id=""tagNotes"" name=""tagNotes"" rows=""15"">"_$c(13,10)
