 ;GT.M version of page docParam (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getParamNo^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="docParam"
 ...
 s Error=$$startSession^%zewdPHP("docParam",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .s paramNo=$$getSessionValue^%zewdAPI("paramNo",sessid)
 .w "      <h4 align=""center"" id=""paramTitle"">"_$c(13,10)
 .w $$getResultSetValue^%zewdAPI("domParams",paramNo,"name",sessid)
 .w "      </h4>"_$c(13,10)
 .w "      <textarea cols=""40"" id=""missingName51"" name=""missingName51"" rows=""8"" style=""border:none"">"_$c(13,10)
