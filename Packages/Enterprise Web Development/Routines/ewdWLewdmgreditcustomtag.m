 ;GT.M version of page editCustomTag (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getCustomTagDetails^%zewdMgrAjax"
 ...
 s sessionArray("ewd_pageName")="editCustomTag"
 ...
 s formInfo="cancel|button`ewd_pressed|hidden`tagImpliedClose|radio`tagMethod|text`tagNotes|textarea`tagSubmit|submit`"
 d setMethodAndNextPage^%zewdCompiler20("tagSubmit","saveCustomTag^%zewdMgrAjax","configSettingsSaved",formInfo,.sessionArray)
 s Error=$$startSession^%zewdPHP("editCustomTag",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "Custom Tag &lt;"_$$getSessionValue^%zewdAPI("tagName",sessid)_"&gt;"_""
 .w "      </h5>"_$c(13,10)
 .w "      <div class=""applicationPanel"" style=""height:320px; width:97%"">"_$c(13,10)
 .w "         <form action='/vista/ewdMgr/editCustomTag.mgwsi?ewd_token="_$$getSessionValue^%zewdAPI("ewd_token",sessid)_"' method=""post"" name=""ewdForm1"">"_$c(13,10)
 ...
 .w "                     <input id=""tagMethod"" name=""tagMethod"" size=""40"" type=""text"" value='"_$$getSessionValue^%zewdAPI("tagMethod",sessid)_"' />"_$c(13,10)
 ...
 .w "               <tr>"_$c(13,10)
 .w "                  <td colspan=""2"">"_$c(13,10)
 .w "                     <input class=""actionButton"" id=""tagSubmit"" name=""tagSubmit"" onClick=""this.form.ewd_action.value=this.name ; this.form.ewd_pressed.value=this.name ; EWD.ajax.submit(this.name,this.form,'configSettingsSaved','/vista/ewdMgr/editCustomTag.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("editCustomTag")_"&ewd_urlNo=editCustomTag1','nullId','') ;"" type=""button"" value=""Save"" />"_$c(13,10)
