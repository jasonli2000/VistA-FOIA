 ;GT.M version of page vaConfigArchitecture (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="vaConfigArchitecture"
 ...
 s Error=$$startSession^%zewdPHP("vaConfigArchitecture",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "   <span>"_$c(13,10)
 .w "      <h3>"_$c(13,10)
 .w "Virtual Appliance Architecture"_""
 .w "      </h3>"_$c(13,10)
 .w "The EWD Virtual Appliance is based on Ubuntu Linux 7.10 JEOS, running as a Virtual Machine in VMWare Player or WorkStation.  In addition, the following components have been added:"_""
 .w "      <ul>"_$c(13,10)
 .w "         <li>"_$c(13,10)
 .w "OpenSSH : SSH Server"_""
 .w "         </li>"_$c(13,10)
 .w "         <li>"_$c(13,10)
 .w "GT.M"_""
 .w "         </li>"_$c(13,10)
 .w "         <li>"_$c(13,10)
 .w "The Free Open Source"_""
 .w "            <i>"_$c(13,10)
 .w "m_apache"_""
 .w "            </i>"_$c(13,10)
 .w "Gateway"_""
 .w "         </li>"_$c(13,10)
 .w "         <li>"_$c(13,10)
 .w "The Free Open Source version of Enterprise Web Developer (EWD)"_""
 .w "         </li>"_$c(13,10)
 .w "      </ul>"_$c(13,10)
 .w "You therefore have a fully functioning, fully configured Open Source environment which should work for most people ""out of the box"".  The Ubuntu JEOS version was used to provide the most efficient run-time environment and to keep the Virtual Machine size as small as possible.  Please note, however, that this means that the Linux environment does not include a graphical user interface.  However, most of the day-to-day interactions with the EWD Virtual Appliance will be via a web browser or SCP client."_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "You can, of course, construct your own Linux Desktop system using the same components that have been used to build the EWD Virtual Appliance.  This Virtual Appliance and these notes should provide all the background details you'll need to build your own equivalent system."_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "The architecture of your EWD Virtual appliance is shown diagrammatically below:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <center>"_$c(13,10)
 .w "         <img src=""/ewd/ewd_va_Architecture.jpg"" />"_$c(13,10)
 .w "      </center>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "You can adapt and modify the setup and configuration of the EWD Virtual Appliance if you wish.  The following notes should provide you with most of the information you need to customise and tune your EWD Virtual Appliance."_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "   </span>"_$c(13,10)
 .
