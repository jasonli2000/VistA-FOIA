 ;GT.M version of page initialSecurity (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageTitle")="Enterprise Web Developer Management Portal : Security"
 ...
 s sessionArray("ewd_pageName")="initialSecurity"
 ...
 d setMethodAndNextPage^%zewdCompiler20("continue","","index",formInfo,.sessionArray)
 s Error=$$startSession^%zewdPHP("initialSecurity",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w "      <title>"_$c(13,10)
 w "M/Gateway Developments Ltd: Enterprise Web Developer Management Portal"_""
 w "      </title>"_$c(13,10)
 ...
 w "      </table>"_$c(13,10)
 w "      <h3>"_$c(13,10)
 w "Welcome to the Enterprise Web Developer Portal."_""
 w "      </h3>"_$c(13,10)
 w "      <p>"_$c(13,10)
 w "Important note: as this is the first time you have accessed the EWD Portal, the IP address of your browser ("_$$getSessionValue^%zewdAPI("ipAddress",sessid)_") has been used to limit future access."_""
 w "      </p>"_$c(13,10)
 w "      <p>"_$c(13,10)
 w "Access to the EWD Portal's web interface is not possible from any other IP address unless you change the security settings"_""
 w "      </p>"_$c(13,10)
 w "      <p>"_$c(13,10)
 w "You will be able to allow other IP addresses to access the Portal  by selecting the Security tab and following the instructions."_""
 w "      </p>"_$c(13,10)
 w "      <p>"_$c(13,10)
 w "It is strongly recommended that you add password protection to the EWD Portal. This can be also be done  by clicking the Security tab in the EWD Portal and following the instructions."_""
 w "      </p>"_$c(13,10)
 w "      <form action='/vista/ewdMgr/initialSecurity.mgwsi?ewd_token="_$$getSessionValue^%zewdAPI("ewd_token",sessid)_"' method=""post"" name=""ewdForm1"">"_$c(13,10)
