 ;GT.M version of page documentation (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="documentation"
 ...
 s Error=$$startSession^%zewdPHP("documentation",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "            <tr>"_$c(13,10)
 .w "               <td>"_$c(13,10)
 .w "                  <table class=""innerTabs"" id=""documentationMenuMenu"">"_$c(13,10)
 .w "                     <tr>"_$c(13,10)
 .w "                        <td id=""domDocumentationTab"" onClick=""EWD.page.fetchdomDocumentation(); EWD.page.setInnerTabPage(this)"" onMouseOut=""EWD.page.deSelectInnerTab(this)"" onMouseOver=""EWD.page.selectInnerTab(this)"">"_$c(13,10)
 .w "DOM APIs"_""
 .w "                        </td>"_$c(13,10)
 .w "                     </tr>"_$c(13,10)
 .w "                  </table>"_$c(13,10)
 .w "                  <div class=""innerPanel"" id=""documentationMenu"">"_$c(13,10)
 .w "&nbsp;"_""
 .w "                  </div>"_$c(13,10)
 .w "               </td>"_$c(13,10)
 .w "            </tr>"_$c(13,10)
 ...
 w ""_""
 w "EWD.page.defineInnerTab('documentationMenu','domDocumentationTab',true) ;"_$c(13,10)
 w "EWD.page.fetchdomDocumentation = function () {"_$c(13,10)
 w "  EWD.ajax.makeRequest('/vista/ewdMgr/domDocumentation.mgwsi?ewd_token="_$g(^%zewdSession("session",sessid,"ewd_token"))_"&n="_tokens("domDocumentation")_"&ewd_urlNo=documentation1','documentationMenu','get','','') ;"_$c(13,10)
 w "} ;"_$c(13,10)
 w "EWD.page.fetchdomDocumentation() ;"_$c(13,10)
 w ""_""
 w "   </pre>"_$c(13,10)
 w "</span>"_$c(13,10)
 QUIT
