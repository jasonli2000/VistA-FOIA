 ;GT.M version of page mgwsiMgr (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="mgwsiMgr"
 ...
 s Error=$$startSession^%zewdPHP("mgwsiMgr",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <span>"_$c(13,10)
 .w "      <iframe frameborder=""0"" height=""800px"" src=""/cgi-bin/nph-mgwsic"" width=""100%"">"_$c(13,10)
 .w "</iframe>"_$c(13,10)
 .w "   </span>"_$c(13,10)
 .
