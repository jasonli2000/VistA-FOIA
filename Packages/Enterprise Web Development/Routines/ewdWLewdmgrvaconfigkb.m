 ;GT.M version of page vaConfigKB (ewdMgr application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="vaConfigKB"
 ...
 s Error=$$startSession^%zewdPHP("vaConfigKB",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .w "   <span>"_$c(13,10)
 .w "      <h3>"_$c(13,10)
 .w "Reconfiguring the Keyboard"_""
 .w "      </h3>"_$c(13,10)
 .w "The EWD Virtual Appliance is configured to expect a UK Keyboard layout.  If you want to change the keyboard configuration, simply login as root (default password is ""1234567"") and type:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "kbd-config"_""
 ...
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "You'll get an initial screen of instructions.  Press the Enter key to select the ""OK"" button at the bottom.  You'll then be given a menu of four options.  Press Enter to select the first option:"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "Select keymap from arch list"_""
 .w "      </i>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <i>"_$c(13,10)
 .w "[Note: to navigate to the Cancel button, use the right/left arrow keys]"_""
 .w "      </i>"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "Next, use the up/down arrow keys to select the appropriate keyboard type (probably ""qwerty"") and press Enter"_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "Then scroll up/down using the up/down arrow keys to select the correct nationality.  Press Enter.  Depending on the keyboard nationality, you may be asked further specific questions, and finally accept the keyboard layout that you've selected.  You'll be returned to the command prompt and the keyboard should now be set to the correct layout."_""
 .w "      <br />"_$c(13,10)
 .w "      <br />"_$c(13,10)
 .w "   </span>"_$c(13,10)
 .
