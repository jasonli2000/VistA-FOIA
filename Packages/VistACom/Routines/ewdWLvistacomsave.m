 ;GT.M version of page save (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="SAVE^C0EMAIL"
 ...
 s sessionArray("ewd_pageName")="save"
 ...
 s Error=$$startSession^%zewdPHP("save",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 w "Ext.getCmp(EWD.sencha.modalPanel).hide();  Ext.Msg.alert('Attention', '"_$$getSessionValue^%zewdAPI("type",sessid)_" has been added to "_$$getSessionValue^%zewdAPI("savePatient",sessid)_"', Ext.emptyFn);"_""
 w "</pre>"_$c(13,10)
