 ;GT.M version of page zewdcm (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="getComboMatches^%zewdCustomTags"
 ...
 s sessionArray("ewd_pageName")="zewdcm"
 ...
 s Error=$$startSession^%zewdPHP("zewdcm",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .d writeListData^%zewdST2("ewdComboMatches",1,sessid)
 .w "EWD.sencha.combo.store.loadData(EWD.sencha.jsonData,false);"_""
 .w "   </pre>"_$c(13,10)
 .
