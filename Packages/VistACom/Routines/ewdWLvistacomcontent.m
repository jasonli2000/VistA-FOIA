 ;GT.M version of page content (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_pageName")="content"
 ...
 s Error=$$startSession^%zewdPHP("content",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 if ($g(Error)="") d
 .w "   <span style=""display:none"">"_$c(13,10)
 .w "      <span id=""ewdSTpageItemcontent63"">"_$c(13,10)
 .w "         <div class=""x-form-fieldset-title"" style=""margin-left:20px;"">"_$c(13,10)
 .w "Info"_""
 .w "         </div>"_$c(13,10)
 .w "         <div class=""stRoundedBox"" style=""padding-bottom:14px"">"_$c(13,10)
 .w "            <div>"_$c(13,10)
 .w "Info will go here"_""
 .w "            </div>"_$c(13,10)
 .w "         </div>"_$c(13,10)
 .w "      </span>"_$c(13,10)
 .w "   </span>"_$c(13,10)
 ...
 w "EWD.sencha.widget.zewdSTcontent15=new Ext.Panel({fullscreen:true,id:""mainPanel"",layout:""fit"",dockedItems:[{dock:""top"",id:""toolBar"",title:""VistACom"",xtype:""toolbar"",items:[{handler:EWD.sencha.onBackBtnTapped,hidden:true,id:""backBtn"",text:""Back to Patients"",ui:""back"",xtype:""button""}"_""
 w ",{xtype:""spacer""},{handler:EWD.sencha.onInfoBtnTapped,hidden:true,id:""infoBtn"",text:""Info"",xtype:""button""}"_""
 w "]}]});"_""
 w "EWD.sencha.widget.zewdSTcontent48=new Ext.Panel({contentEl:""ewdSTpageItemcontent63"",floating:true,height:400,hidden:true,id:""infoPanel"",layout:""fit"",modal:true,scroll:""vertical"",width:400}"_""
 w ");"_""
 w "var nextPage = '"_$$getSessionValue^%zewdAPI("nextPage",sessid)_"';  EWD.ajax.getPage({page: nextPage});"_""
 w "EWD.sencha.loadCardPanel('content','mainPanel');"_""
 w "EWD.sencha.loadCardPanel('content','infoPanel');"_""
 w "</pre>"_$c(13,10)
