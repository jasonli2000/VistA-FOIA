 ;GT.M version of page xml (VistACom application)
...
pre() ;
 ...
 s sessionArray("ewd_prePageScript")="INIT^C0ECCR"
 ...
 s sessionArray("ewd_pageName")="xml"
 ...
 s Error=$$startSession^%zewdPHP("xml",.%KEY,.%CGIEVAR,.sessionArray,.filesArray)
...
body ;
 ...
 .D STREAM^C0EVCOM("xml",sessid)
 .w "EWD.sencha.widget.zewdSTxml24=new Ext.Panel({contentEl:""ewdSTpageItemxml33"",id:""xml"",layout:""fit"",scroll:""vertical"",title:""XML""}"_""
 .w ");"_""
 .w "transform(xml, xslt, 'ccrCode');  xml = '';  xslt = '';  Ext.get('temp-xml').dom.innerHTML = '';"_""
 .w "Ext.getCmp('ccr').add(Ext.getCmp('xml'));Ext.getCmp('ccr').doLayout();"_""
 .w "EWD.sencha.loadCardPanel('xml','xml');"_""
 .w "   </pre>"_$c(13,10)
 .w "   <span style=""display:none"">"_$c(13,10)
 .w "      <span id=""ewdSTpageItemxml33"">"_$c(13,10)
 .w "         <div class=""x-form-fieldset-title"" style=""margin-left:20px;"">"_$c(13,10)
 .w "Continuity of Care Record"_""
 .w "         </div>"_$c(13,10)
 .w "         <div class=""stShadowBox"" style=""padding-bottom:14px"">"_$c(13,10)
 .w "            <div id=""ccrCode"">"_$c(13,10)
 .w "</div>"_$c(13,10)
 .w "         </div>"_$c(13,10)
 .w "      </span>"_$c(13,10)
 .w "   </span>"_$c(13,10)
