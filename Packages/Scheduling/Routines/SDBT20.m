...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="SDBT20",DQ=1
1 S D=0 K DE(1) ;2501
 S DIFLD=2501,DGO="^SDBT21",DC="1^44.04PA^SDPRIV^",DV="44.04MP200'X",DW="0;1",DOW="PRIVILEGED USER",DLB="Select "_DOW
 S DU="VA(200,"
 G RE:D I $D(DSC(44.04))#2,$P(DSC(44.04),"I $D(^UTILITY(",1)="" X DSC(44.04) S D=$N(^(0)) G M1
