ECXPLBB ;DALOI/KML - DSS BLOOD BANK PRE-EXTRACT AUDIT REPORT ;6/26/12  16:40
 ;;3.0;DSS EXTRACTS;**78,92,105,136**;Dec 22, 1997;Build 28
...
OUTPUT ; entry point called by EN tag
 ...
 S ECXCOMP=0 F  S ECXCOMP=$O(^TMP("ECXLBB",ECXJOB,ECXCOMP)) Q:ECXCOMP=""  D  Q:ECQUIT
 . S ECXDFN=0 F  S ECXDFN=$O(^TMP("ECXLBB",ECXJOB,ECXCOMP,ECXDFN)) Q:'ECXDFN  D  Q:ECQUIT
 .. S ECXDATE=0 F  S ECDATE=$O(^TMP("ECXLBB",ECXJOB,ECXCOMP,ECXDFN,ECDATE))  Q:'ECDATE  Q:ECQUIT  S ECXSTR=^(ECDATE) D PRINT
 D ^ECXKILL
 Q
 ;
PRINT ;
