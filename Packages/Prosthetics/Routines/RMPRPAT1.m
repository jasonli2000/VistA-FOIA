RMPRPAT1 ;PHX/HNB/RFM/JLT-DISPLAY PATIENT INFO ;8/29/1994
 ;;3.0;PROSTHETICS;**29,155**;Feb 09, 1996;Build 4
 W @IOF S PAGE=2
...
ASK1 ;SET DIR AND FOR SCREEN NUMBER DISPLAY
 K DIR S DIR("A")="Enter 10-2319 screen to VIEW (1-8),'^' to EXIT, or 'return' to continue: "
  N % S DIR(0)="SAO^1:PATIENT DEMOGRAPHICS;2:CLINIC ENROLLMENTS/CORRESPONDENCE;3:ENTITLEMENT INFORMATION;4:APPLIANCE TRANSACTIONS;5:AUTO ADAPTIVE INFORMATION;6:CRITICAL COMMENTS;7:ADD/EDIT DISABILITY CODE;8:HOME OXYGEN ITEMS;"
 S DIR("?")="Enter a screen number (1-8) OR '^' TO EXIT."
