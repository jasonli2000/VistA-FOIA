PRCPRTR1 ;WISC/RFJ-transaction register report (print) ;07 Sep 91
 ;;5.1;IFCAP;**24,127**;Oct 20, 2000;Build 15
...
P1 S ITEMDA=$O(^TMP($J,"PRCPRTRA",ITEMDA)),PRCPDT=0 G 9:ITEMDA=""!($D(PRCPFLAG)) S PAGE=0
...
H S PAGE=PAGE+1,%=NOW_"  PAGE "_PAGE
 ...
 I 'SCREEN,PAGE=1 W @IOF
 I 'SCREEN,PAGE>1 S X="",$P(X," ",81)="" W !,X,!,X K X
